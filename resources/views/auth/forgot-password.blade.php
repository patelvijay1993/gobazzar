@extends('layouts.app')
@section('title', 'Forgot Password — GoBazaar')
...
<div class="auth-page">
  <div class="auth-box">
    ...
    <div class="auth-card">
      ...
      <div class="auth-body">
        @if(session('success'))
          <div style="background:#f0fdf4;color:#16a34a;border:1px solid #bbf7d0;border-radius:8px;padding:13px 14px;margin-bottom:18px;font-size:13px;display:flex;align-items:flex-start;gap:8px">
            <i class="fa-solid fa-circle-check" style="margin-top:2px"></i>
            <div>
              <strong>Email sent!</strong><br>
              If that address is registered, you'll receive a password reset link shortly. Check your inbox (and spam folder).
            </div>
          </div>
        @endif
