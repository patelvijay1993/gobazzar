    ...
    <div class="form-card">
      ...
      <div class="form-card-body">
        ...
        <div class="form-section">
          ...
          @endif
          <x-image-uploader name="images" :multiple="true" :max="$maxImages" :label="'Photos (up to '.$maxImages.')'" hint="Recommended: 800×600px (4:3) · JPG/PNG · Max 1MB each · Leave empty to keep current photos" :crop="true" aspect="4/3" />
        </div>
    ...
    <div class="form-card">
      ...
      <div class="form-card-body">
        ...
        <div class="form-section">
          ...
          @endif
          <x-image-uploader name="company_logo" :multiple="false" :max="1" label="Company Logo" hint="Recommended: 200×200px square · PNG transparent preferred · Max 1MB · Leave empty to keep current" :crop="true" aspect="1/1" />
        </div>
        <button type="submit" class="btn-save">Save Changes</button>
        <a href="{{ route('account') }}" class="btn-cancel">Cancel</a>
      </div>
      ...
      <div class="form-card-body">
        ...
        <div class="form-row">
          ...
          <div class="form-group">
            ...
            <input type="url" name="map_url" class="form-input" value="{{ old('map_url',$record->map_url) }}" placeholder="Paste Google Maps link (e.g. https://maps.app.goo.gl/…)">
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="form-card" style="margin-bottom:20px">
      ...
      <div class="form-card-body">
        ...
        <div style="margin-bottom:20px">
          <x-image-uploader name="images" :multiple="true" :max="$maxImages" :label="'Add / Replace Photos (up to '.$maxImages.')'" hint="Recommended: 1200×628px (16:9) · First photo = main banner · Max 1MB each · Leave empty to keep current" :crop="true" aspect="16/9" />
        </div>
        @if($record->logo)
          <div style="margin-bottom:12px">
            <div class="form-label" style="margin-bottom:6px">Current Logo</div>
        ...
        @endif
        <x-image-uploader name="logo" :multiple="false" :max="1" label="Business Logo" hint="Recommended: 200×200px square · PNG transparent preferred · Max 1MB · Leave empty to keep current" :crop="true" aspect="1/1" />
      </div>
    </div>
    ...
    <div class="form-card">
      ...
      <div class="form-card-body">
        ...
        <div class="form-section">
          ...
          @endif
          <x-image-uploader name="photo" :multiple="false" :max="1" label="Profile Photo" hint="Recommended: 400×400px square · Clear face photo · Max 1MB · Leave empty to keep current" :crop="true" aspect="1/1" />
          <div style="margin-top:16px">
            <x-image-uploader name="photos" :multiple="true" :max="$maxImages" label="Additional Photos (Gallery)" hint="Upload up to {{ $maxImages }} additional photos · Leave empty to keep current gallery" :crop="true" aspect="4/3" />
          </div>
        </div>
        <button type="submit" class="btn-save">Save Changes</button>
        <a href="{{ route('account') }}" class="btn-cancel">Cancel</a>
    ...
    <div class="form-card">
      ...
      <div class="form-card-body">
        ...
        <div class="form-section">
          ...
          @endif
          <x-image-uploader name="images" :multiple="true" :max="$maxImages" :label="'Post Photos (up to '.$maxImages.')'" hint="Recommended: 800×600px (4:3) · JPG/PNG · Max 1MB each · Leave empty to keep current photos" :crop="true" aspect="4/3" />
        </div>
