      ...
      <div class="form-card">
        ...
        <div class="form-card-body">
          <div class="form-section">
            ...
            <div class="form-row" style="margin-top:14px">
              ...
              <div class="form-group">
                ...
                <input type="text" name="postal_code" class="form-input" value="{{ old('postal_code') }}" placeholder="M5V 3A8" maxlength="10">
              </div>
            </div>
          </div>
          ...
          <div class="form-section">
            ...
            <x-image-uploader name="images" :multiple="true" :max="$maxImages" :min="2" :label="'Photos (up to '.$maxImages.')'" :hint="'Recommended size: 800×600px (4:3) · Max 1MB per photo · '.$user->planName().' plan allows '.$maxImages.' photos · Min 2 required'" :crop="true" aspect="4/3" />
          </div>
      ...
      <div class="form-card">
        ...
        <div class="form-card-body">
          ...
          <div class="form-section">
            ...
            <x-image-uploader name="company_logo" :multiple="false" :max="1" label="Company Logo" hint="Recommended: 200×200px square · PNG with transparent background preferred · Max 1MB" :crop="true" aspect="1/1" />
          </div>
      ...
      <div class="form-card">
        ...
        <div class="form-card-body">
          ...
          <div class="form-section">
            ...
            <x-image-uploader name="image" :multiple="false" :max="1" label="Event Banner / Photo" hint="Recommended: 1200×628px (16:9 landscape) · Max 1MB · Wide banner looks best" :crop="true" aspect="16/9" />
          </div>
      ...
      <div class="form-card" style="margin-bottom:20px">
        ...
        <div class="form-card-body">
          ...
          <div style="margin-bottom:20px">
            <x-image-uploader name="images" :multiple="true" :max="$maxImages" :min="2" :label="'Business Photos (up to '.$maxImages.')'" :hint="'Recommended: 1200×628px (16:9) · First photo = main banner on your listing · Max 1MB each · Min 2 required'" :crop="true" aspect="16/9" />
          </div>
          <x-image-uploader name="logo" :multiple="false" :max="1" label="Business Logo" hint="Recommended: 200×200px square · PNG with transparent background preferred · Max 1MB · Shows on your listing card" :crop="true" aspect="1/1" />
        </div>
      </div>
        ...
        <div class="form-card">
          ...
          <div class="form-card-body">
            ...
            <div class="form-section">
              ...
              <x-image-uploader name="images" :multiple="true" :max="$maxImages" :min="2" :label="'Post Photos (up to '.$maxImages.')'" :hint="'Recommended: 800×600px (4:3) · First photo = main image on your post · Max 1MB each · Min 2 required'" :crop="true" aspect="4/3" />
            </div>
      ...
      <div class="form-card">
        ...
        <div class="form-card-body">
          ...
          <div class="form-section">
            ...
            <x-image-uploader name="photo" :multiple="false" :max="1" label="Profile Photo" hint="Recommended: 400×400px square · Clear face photo · Max 1MB" :crop="true" aspect="1/1" />
            <div style="margin-top:16px">
              <x-image-uploader name="photos" :multiple="true" :max="$maxImages" label="Additional Photos (Gallery)" hint="Upload up to {{ $maxImages }} additional photos to showcase your profile" :crop="true" aspect="4/3" />
            </div>
          </div>
